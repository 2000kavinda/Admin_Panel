...
class StMenu extends StatefulWidget {
  ...
  StMenu({required this.textValue});

  @override
  State<StMenu> createState() => _StMenuState();
}
              ...
              children: [
                ...
                InkWell(
                  onTap: () {
                    ...
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => personalData(textValue: widget.textValue,)),
                    );
                  },
                  child: Ink(
                    decoration: BoxDecoration(
                            ...
                            InkWell(
                              onTap: () {
                                ...
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                      builder: (context) => Marks(textValue: widget.textValue,)),
                                );
                              },
                              child: Ink(
                                decoration: BoxDecoration(
                            ...
                            InkWell(
                              onTap: () {
                                ...
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                      builder: (context) => MyOrders(textValue: widget.textValue,)),
                                );
                              },
                              child: Ink(
                                decoration: BoxDecoration(
                        ...
                        InkWell(
                          onTap: () {
                            ...
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => BottomBarCanteen(textValue: widget.textValue,)),
                            );
                          },
                          child: Ink(
                            decoration: BoxDecoration(
