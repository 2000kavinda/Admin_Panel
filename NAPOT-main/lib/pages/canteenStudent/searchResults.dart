...
class SearchResults extends StatefulWidget {
  ...
  SearchResults({required this.textValue});
...
class _SearchResultsState extends State<SearchResults> {
  ...
  void post() async {
    ...
    String resp = await StoreData()
        .saveData(email: email,id: id, itemName: itemName, description: description, price: price, quantity: quantity);
  }
